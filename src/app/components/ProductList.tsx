  ...
  return (
    <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 p-10">
      {products.map((item) => (
        <li
          key={item.id}
          className="p-2 rounded-[10px] flex-col border-[1px] border-gray-700 items-center"
        >
          <Image
            src={item.image}
            alt={item.name}
          ...
          <button
            ...
            className="bg-gray-700 text-white p-2 my-6 rounded-md text-[12px] w-full px-4 hover:bg-gray-800"
          >
            افزودن به سبد خرید
          </button>
        </li>
